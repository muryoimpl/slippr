  ...
  render() {
    ...
    return (
      <footer className={`toolbar toolbar-footer ${fullscreen ? 'c-footer-btn-group__hidden' : 'c-btn-group__disappear'}`}>
        <button type="button" className="c-footer-btn__show" onClick={() => this.handlePrevPage()} title="Previous page">
          <span className={`icon icon-left ${disabledPrevClass}`} />
        </button>

        <button type="button" className="c-footer-btn__center ma" onClick={() => this.handleNormalScreen(false)} title="Finish full screen">
          <span className="icon icon-down-bold" />
        </button>

        <button type="button" className="c-footer-btn__show pull-right" onClick={() => this.handleNextPage()} title="Next page">
          <span className={`icon icon-right ${disabledNextClass}`} />
        </button>
      </footer>
    );
  }
...
Footer.propTypes = {
  ...
  markdownPages: PropTypes.arrayOf(PropTypes.object),
